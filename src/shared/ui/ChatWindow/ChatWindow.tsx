...
export const ChatWindow = ({ question, answer, isLoading }: Props) => (
  <div className="border border-white/80 rounded-md flex flex-col p-4 gap-4">
    ...
    <div className="bg-white/30 flex items-center gap-4 max-w-[calc(100%-40px)] p-4 rounded-md self-end border-white/50 hover:border-white/80 transition-all cursor-pointer">
      <b>AI:</b>{" "}
